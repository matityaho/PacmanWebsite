...
function UpdatePositionMonster() {
	...
	if(monster4.alive==1){
		...
		if(board[monster4.i][monster4.j] == 2){
	...
	function upButtom(){
		...
		addEventListener('keydown', function f(e) {
			if (e != undefined && !upPressed){
				...
				upKey=e.key;
				if(upkeyValue == 32){
					$('#buttomUp').after('<span id="buttomUpK" class="text">- space</span>');
				}
				else{
					$('#buttomUp').after('<span id="buttomUpK" class="text">- '+upKey+'</span>');
				}
				upPressed=true;
	...
	function rightButtom(){
		...
		addEventListener('keydown', function f(e) {
			if (e != undefined && !rightPressed){
				...
				rightKey=e.key;
				if(rightkeyValue == 32){
					$('#buttomRight').after('<span id="buttomRightK" class="text">- space</span>');
				}
				else{
					$('#buttomRight').after('<span id="buttomRightK" class="text">- '+rightKey+'</span>');
				}
				rightPressed=true;
	...
	function downButtom(){
		...
		addEventListener('keydown', function f(e) {
			if (e != undefined && !downPressed){
				...
				downKey=e.key;
				if(downkeyValue== 32){
					$('#buttomDown').after('<span id="buttomDownK" class="text">- space</span>');
				}
				else{
					$('#buttomDown').after('<span id="buttomDownK" class="text">- '+downKey+'</span>');
				}
				downPressed=true;
	...
	function leftButtom(){
		...
		addEventListener('keydown', function f(e) {
			if (e != undefined && !leftPressed){
				...
				leftKey=e.key;
				if(leftkeyValue== 32){
					$('#buttomLeft').after('<span id="buttomLeftK" class="text">- space</span>');
				}
				else{
					$('#buttomLeft').after('<span id="buttomLeftK" class="text">- '+leftKey+'</span>');
				}
				leftPressed=true;
